# -*- coding: utf-8 -*-
{
    ...
    'description': """
        ...
        taking a VALPICK selection, and handling it to a carrier,
    ...
    'assets': {
        "web.assets_backend": [  
            "/wb_outs/static/src/js/GuideScanner.js",
            "/wb_outs/static/src/css/GuideScanner.scss",
        ],

        'web.assets_qweb': [
            '/wb_outs/static/src/xml/GuideScanner.xml',          
        ],
